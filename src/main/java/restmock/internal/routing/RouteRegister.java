package restmock.internal.routing;

import java.io.IOException;
import java.net.URLConnection;
import java.util.Objects;

import restmock.ResponseOptions;
import restmock.RestMockResponse;
import restmock.internal.response.Binary;
import restmock.internal.response.ContentType;
import restmock.internal.response.Html;
import restmock.internal.response.JSON;
import restmock.internal.response.NotConfigured;
...
import restmock.internal.utils.Resource;
